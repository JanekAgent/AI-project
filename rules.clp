...
(defrule fantasy
    ...
    =>
    retract(?f1)
    (asked "asked" "Do you want a dungeon crawling adventure?" "Yes" "No" )
...
(defrule dungeonCrawlingAdventure
    ...
    =>
    retract(?f1)
    (asked "asked" "A serious one?" "Yes" "No" )
...
(defrule serious
    ...
    =>
    retract(?f1)
    (asked "asked" "How many players" "Just two of us" "More than two" )
...
(defrule justTwoOfUs
    ...
    =>
    retract(?f1)
    (asked "asked" "Crush or out-maneuver your enemies?" "Fight" "Maneuver" )
)
(defrule crush
...
(defrule moreThanTwo
    ...
    =>
    retract(?f1)
    (asked "asked" "Cooperative or competitive?" "Cooperative" "Competitive" )
)
(defrule cooperative
    ...
    =>
    retract(?f1)
    (asked "asked" "Playing with kids?" "Yes" "No" )
)
...
(defrule notPlayingWithKids
    ...
    =>
    retract(?f1)
    (game "Dungeons ad Dragons: Legend of Drizzt")
...
(defrule competitive
    ...
    =>
    retract(?f1)
    (asked "asked" "Do you want a campaign?" "Yes" "Just one game" )
)
(defrule campaign
    ...
    =>
    retract(?f1)
    (game "Descent: Journeys in the Dark 2nd Edition")
)
(defrule justOneGame
    ?f1<-(asked "asked" "Do you want a campaign?" $?answers)
...
(defrule notSerious
    ...
    =>
    retract(?f1)
    (asked "asked" "How about managing your own dungeon?" "Yes" "No" )
)
...
(defrule notManagingYourOwnDungeon
    ...
    =>
    retract(?f1)
    (asked "asked" "Want the whole questing thing, eh?" "Yes" "No" )
)
(defrule wholeQuestingThing
    ...
    =>
    retract(?f1)
    (asked "asked" "Competitive or cooperative?" "Competitive" "Cooperative" "Cooperative - if I can backstab" )
...
(defrule competitiveQuestDungeon
    ...
    =>
    retract(?f1)
    (asked "asked" "Mind getting trounced by random events?" "Yes, Strategy matters" "No, it's the experience that counts" )
)
...
(defrule experienceCounts
    ...
    =>
    retract(?f1)
    (asked "asked" "Is storytelling important?" "Yes" "Not as much as combat!" )
)
...
(defrule cooperativeQuestDungeon
    ...
    =>
    retract(?f1)
    (asked "asked" "Board or card game?" "Boards" "Cards" )
...
(defrule noQuesting
    ...
    =>
    retract(?f1)
    (asked "asked" "Do you like Deckbuilders?" "Yes" "No" )
)
(defrule deckBuilders
    ...
    =>
    retract(?f1)
    (asked "asked" "Competitive Deck Builders?" "Competitive" "Cooperative" )
)
...
(defrule noDeckBuilders
    ...
    =>
    retract(?f1)
    (asked "asked" "Lord of the Rings fan?" "Yes" "No" )
)
...
(defrule noLordOfTheRingsFan
    ...
    =>
    retract(?f1)
    (asked "asked" "How about a castle defence? "Sounds fun!" "Not for me" )
)
(defrule soundsFun
...
(defrule notSoundsFun
    ...
    =>
    retract(?f1)
    (asked "asked" "Conquest in a fantasy world?" "Yes" "No" )
...
(defrule conquestInAFantasyWorld
    ...
    =>
    retract(?f1)
    (asked "asked" "Epic?" "Yes! It's gotta be big" "No,keep it quick" )
)
(defrule epic
...
(defrule noConquestInAFantasyWorld
    ...
    =>
    retract(?f1)
    (asked "asked" "Everday life, eh?" "Running a business" "Relaxing after work" "Annihilating your business rivals" )
)
